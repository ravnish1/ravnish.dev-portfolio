...
export default function JobOffer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // NOTE: To make Nodemailer work, you need a backend endpoint (e.g. Next.js API route or Express server)
      // For now, this will mock the submission or point to a Vercel serverless function if you deploy one.
      const response = await fetch('/api/send-email', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ type: 'Job', ...formData })
      })
      ...
      if (response.ok) {
        ...
        setFormData({
          companyName: '', email: '', designation: '', ctc: '', mobile: '', workAreas: '', additionalDetails: ''
        })
      }
    } catch (error) {
            ...
            <div className="job-offer-form">
              ...
              <div className="form-group">
                ...
                >
                  ...
                  <option value="Not Specified">Not Specified / General</option>
                  <option value="Other">Other</option>
                </select>
              </div>
